...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    if (page === "login") {
      ...
      } else if (typeof initArmoryAdminTools === "function") {
        await initArmoryAdminTools();
      }
      return;
    }
        ...
        document.querySelector(".app-main").innerHTML = `
          ...
          <section class="content-panel">
            <div class="locked-panel">
              ...
              <p>This panel is only available to authorized Command, S4 - Research and Development, or Admin Discord roles.</p>
            </div>
          </section>
        `;
      } else if (typeof initArmoryAdminTools === "function") {
