...
function accessKeyFromRoleName(roleName: string) {
  ...
  if (normalized.includes("s4") && (normalized.includes("research") || normalized.includes("development") || normalized.includes("rd"))) return "s4_rd";
  if (normalized.includes("research") && normalized.includes("development")) return "s4_rd";
