-- Red Squadron Armory V44 Admin Monitor Logs
-- Run this after v41_live_armory_editor.sql. Re-run safely if V43 was already applied.
-- This adds a safe audit log table and clear-log policy for Command / S4 R&D / Admin actions.
